...
VALUES
  ...
  (1200021, 'sim_flo2d_dehiwala_canal', 'Dehiwala Canal', 6.8631888889, 79.8635111111, 0),
  (1200022, 'sim_flo2d_near_sllrdc', 'Near SLLRDC', 6.9097555556, 79.8890111111, 0),
  (1200023, 'sim_flo2d_kirimandala_mw', 'Kirimandala Mw', 6.8945555556, 79.8840222222, 0),
  (1200024, 'sim_flo2d_ousl_narahenpita_rd', 'OUSL-Narahenpita Rd', 6.888825, 79.8807583333, 0),
  (1200025, 'sim_flo2d_swarna_rd_wellawatta', 'Swarna Rd-Wellawatta', 6.8832, 79.8711861111, 0),
  (1200026, 'sim_flo2d_mutwal_outfall', 'Mutwal Outfall', 6.9620416667, 79.8578027778, 0),
  (1200027, 'sim_flo2d_thummodara', 'Thummodara', 6.8850583333, 79.8710888889, 0),
  (1200028, 'sim_flo2d_janakalakendraya', 'JanakalaKendraya', 6.8919777778, 79.9217277778, 0),
  (1200029, 'sim_flo2d_kotiyagoda', 'Kotiyagoda', 6.9102222222, 79.9042444444, 0),
  (1200030, 'sim_flo2d_lesliranagala_mw', 'LesliRanagala Mw', 6.9175944444, 79.8841416667, 0),
  (1200031, 'sim_flo2d_babapulle', 'Babapulle', 6.9420222222, 79.87205, 0),
  (1200032, 'sim_flo2d_ingurukade_jn', 'Ingurukade Jn', 6.9510083333, 79.8746916667, 0),
  (1200033, 'sim_flo2d_amaragoda', 'Amaragoda', 6.8886666667, 79.9576166667, 0),
  (1200034, 'sim_flo2d_malabe', 'Malabe', 6.9059305556, 79.9633138889, 0),
  (1200035, 'sim_flo2d_madinnagoda', 'Madinnagoda', 6.9160277778, 79.8993472222, 0),
  (1200036, 'sim_flo2d_kittampahuwa', 'Kittampahuwa', 6.94525, 79.8859611111, 0),
  (1200037, 'sim_flo2d_weliwala_pond', 'Weliwala Pond', 6.9278916667, 79.9167055556, 0),
  (1200038, 'sim_flo2d_old_awissawella_rd', 'Old Awissawella Rd', 6.9431666667, 79.9244888889, 0),
  (1200039, 'sim_flo2d_kelani_mulla_outfall', 'Kelani Mulla Outfall', 6.9467722222, 79.9194222222, 0),
  (1200040, 'sim_flo2d_wellampitiya', 'Wellampitiya', 6.9371805556, 79.8972388889, 0),
  (1200041, 'sim_flo2d_talatel_culvert', 'Talatel Culvert', 6.9325916667, 79.9266416667, 0),
  (1200042, 'sim_flo2d_wennawatta', 'Wennawatta', 6.9359694444, 79.9281611111, 0),
  (1200043, 'sim_flo2d_vivekarama_mw', 'Vivekarama Mw', 6.9405805556, 79.8971583333, 0),
  (1200044, 'sim_flo2d_koratuwa_rd', 'Koratuwa Rd', 6.9309638889, 79.9125972222, 0),
  (1200045, 'sim_flo2d_harwad_band', 'Harwad Band', 6.9292194444, 79.9023333333, 0),
  (1200046, 'sim_flo2d_baira_lake_nawam_mw', 'Baira Lake Nawam Mw', 6.9207638889, 79.8611055556, 0),
  (1200047, 'sim_flo2d_baira_lake_railway', 'Baira Lake Railway', 6.9339333333, 79.8479527778, 0),
  (1200048, 'sim_flo2d_kibulawala_1', 'Kibulawala 1', 6.8667305556, 79.9316305556, 0),
  (1200049, 'sim_flo2d_kibulawala_2', 'Kibulawala 2', 6.8668222222, 79.9308972222, 0),
  (1200050, 'sim_flo2d_parlimant_lake_side', 'Parlimant Lake Side', 6.877225, 79.9277666667, 0),
  (1200051, 'sim_flo2d_polduwa_parlimant_rd', 'Polduwa-Parlimant Rd', 6.9035083333, 79.9090222222, 0),
  (1200052, 'sim_flo2d_abagaha_jn', 'Abagaha Jn', 6.9128944444, 79.9085861111, 0),
  (1200053, 'sim_flo2d_aggona', 'Aggona', 6.9158916667, 79.9267666667, 0),
  (1200054, 'sim_flo2d_rampalawatta', 'Rampalawatta', 6.8841527778, 79.9328, 0);
